...
<body>
    ...
    <nav class="topnav">
        ...
        <span class="page-title">/ Member</span>
                                ...
                                <tr id="row-<?= $m['id_member'] ?>">
                                    ...
                                    <td>
                                        <div class="action-cell">
                                            <button class="btn-icon blue" title="Edit" onclick="openEdit(<?= $m['id_member'] ?>,'<?= addslashes(htmlspecialchars($m['nama_lengkap'])) ?>','<?= addslashes(htmlspecialchars($m['no_hp'])) ?>','<?= addslashes(htmlspecialchars($m['alamat'])) ?>')">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button class="btn-icon red" title="Hapus" onclick="confirmHapus(<?= $m['id_member'] ?>,'<?= addslashes(htmlspecialchars($m['nama_lengkap'])) ?>')">
    ...
    <script>
            ...
            fetch(BASE_URL, { method: 'POST', body: fd })
                ...
                .then(d => {
                    if (d.success) {
                        closeModal('m-tambah');
                        showToast(d.message);
                        insertRow(d.id, d.nama, d.hp, d.alamat);
        ...
        function insertRow(id, nama, hp, alamat) {
            ...
            row.innerHTML = `
                ...
                <td>
                    <div class="action-cell">
                        <button class="btn-icon blue" title="Edit" onclick="openEdit(${id},'${nama.replace(/'/g, "\\'")}','${hp.replace(/'/g, "\\'")}','${alamat.replace(/'/g, "\\'")}')">
                            <i class="fas fa-edit"></i>
                        </button>
